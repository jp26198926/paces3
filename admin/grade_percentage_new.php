<div class="modal " id="grade_percentage_new" data-keyboard="false" data-backdrop="static" style='z-index: 10028;'>
            ...
            <div class="modal-body">
            	<div class="row">
                    <div class="col-md-12  form-group">                           
                        ...
                        <select id="txt_grade_percentage_subject" class='form-control'>
                        	<?php
                        		include('connect.php');
				...
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        ...
                        <select id="txt_grade_percentage_category" class='form-control'>
                        	<?php
                        		include('connect.php');
				...
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        ...
                        <input id="txt_grade_percentage_val" type='text' class='form-control numeric txt_grade_percentage '  />
					</div>					
				</div>
