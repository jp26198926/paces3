<div class="modal " id="offence_modify" data-keyboard="false" data-backdrop="static" style='z-index: 10028;'>
    <div class="modal-dialog" id="modal-danger">
        <div class="modal-content">
            <div class="modal-header">				
				...
				<input type="hidden" class="offence_id" value="0" />
			</div>   
				...
				<div class="row form-group text-center" >
                    <div class="col-sm-12">
						<div class='pull-right' id='cc_buttons'>
							<button id="btn_offence_update" class='btn btn-success'><i class='fa fa-check fa-fw'></i> Save</button>
