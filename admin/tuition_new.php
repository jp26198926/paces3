            ...
            <div class="modal-body">
				...
				<div class="row">
                    <div class="col-md-6  form-group">                           
                        ...
                        <input id="txt_tuition_fee" type='text' class='form-control numeric text-center' value='0.00' />
					</div>	
					<div class="col-md-6  form-group">                           
                        <label >General Fee  <span class='text-danger'>*</span></label>
                        <input id="txt_general_fee" type='text' class='form-control numeric text-center' value='0.00' />
					</div>		
				</div>
				<div class="row">
                    <div class="col-md-6  form-group">                           
                        <label >Auxiliary Fee  <span class='text-danger'>*</span></label>
                        <input id="txt_auxiliary_fee" type='text' class='form-control numeric text-center' value='0.00' />
					</div>	
					<div class="col-md-6  form-group">                           
                        <label >Other Fee  <span class='text-danger'>*</span></label>
                        <input id="txt_other_fee" type='text' class='form-control numeric text-center' value='0.00'  />
					</div>		
				</div>
