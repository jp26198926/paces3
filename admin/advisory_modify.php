<div class="modal " id="advisory_modify" data-keyboard="false" data-backdrop="static" style='z-index: 10028;'>
    <div class="modal-dialog modal-sm" id="modal-danger">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<input type="hidden" class="advisory_id" value="0" />
				
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        <label >Adviser<span class='text-danger'>*</span></label>
                        <select id="txt_adviser_update" class="form-control" >
