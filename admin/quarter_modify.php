<div class="modal " id="quarter_modify" data-keyboard="false" data-backdrop="static" style='z-index: 10028;'>
    <div class="modal-dialog modal-sm" id="modal-danger">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<input type='hidden' class='quarter_id' value='0' />
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        <label >Quarter Name<span class='text-danger'>*</span></label>
                        <input id="txt_quarter_update" type='text' class='form-control numeric txt_quarter '  />
					</div>					
				</div>
