<div class="modal " id="gradecategory_modify" data-keyboard="false" data-backdrop="static" style='z-index: 10028;'>
    <div class="modal-dialog modal-sm" id="modal-danger">
        <div class="modal-content">
            <div class="modal-header">				
				<h4 class="modal-title" style='font-weight: bold;'>
					<span class='fa fa-edit'> </span>
					Modify Grade Category
				</h4>
				
			</div>   
            <div class="modal-body">
				<input type='hidden' class='gradecategory_id' value='0' />
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        <label >Grade Category Name<span class='text-danger'>*</span></label>
                        <input id="txt_gradecategory_update" type='text' class='form-control numeric txt_gradecategory '  />
					</div>					
				</div>
