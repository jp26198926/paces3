            ...
            <div class="modal-body">
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        ...
                        <input id="txt_subject" type='text' class='form-control numeric txt_subject '  />
					</div>					
				</div>
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        <label >Subject Description</label>
                        <input id="txt_subject_description" type='text' class='form-control numeric txt_subject '  />
					</div>					
				</div>		
			</div>
