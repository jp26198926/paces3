			...
			if ($search){
				...
				if ($count > 0){
					while($row = $search->fetch_object()){
						...
						//handle background color of row
						switch($status_id){							
							case 2: //for payment
								echo "<tr id='tr_{$student_id}' class='warning'>";
								break;
							case 3: //payment done
								echo "<tr id='tr_{$student_id}' class='info'>";
								break;
							case 4: //enrolled
								echo "<tr id='tr_{$student_id}' class='success'>";
								break;
							case 5: //cancelled
								echo "<tr id='tr_{$student_id}' class='danger'>";
								break;
							default:
