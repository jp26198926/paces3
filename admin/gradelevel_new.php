<div class="modal " id="gradelevel_new" data-keyboard="false" data-backdrop="static" style='z-index: 10028;'>
            ...
            <div class="modal-body">
				<div class="row">
                    <div class="col-md-12  form-group">                           
                        ...
                        <input id="txt_gradelevel" type='text' class='form-control numeric txt_gradelevel '  />
					</div>					
				</div>
